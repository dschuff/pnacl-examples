...
w_iframe_flex_fudge=25;
h_iframe_flex_fudge=25;

function window_width() {
  return window.innerWidth - w_iframe_flex_fudge;
}

function window_height() {
  return window.innerHeight - h_iframe_flex_fudge;
}
...
function onDocumentKeyDown(event) {
  console.log('onDocumentKeyDown code: ' + event.keyCode);
	if (event.keyCode == 72 || event.keyCode == 104) {
      ...
      console.log('Picking obj at x: ' + mouse.x + ' y: ' + mouse.y);
